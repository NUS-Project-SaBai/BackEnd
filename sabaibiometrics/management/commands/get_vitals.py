        ...
        try:
            ...
            for row in rows:
                vital = Vitals.objects.create(
                    ...
                    heart_rate=row[9],
                    visit_id=row[10],
                    blood_glucose=row[11],
                    hemocue_count=row[13],
                    left_eye_degree=row[14],
                    right_eye_degree=row[15],
                    diabetes_mellitus=row[18],
                    left_eye_pinhole=row[19],
                    right_eye_pinhole=row[20],
                    others=row[21],
                )
