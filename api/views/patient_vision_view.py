...
from api.serializers.patient_vision_serializer import PatientVisionVMOut, VitalsVisionPickOut
...
class VisionView(APIView):
    def get(self, request):
        ...
        return Response(PatientVisionVMOut(payload).data, status=status.HTTP_200_OK)
