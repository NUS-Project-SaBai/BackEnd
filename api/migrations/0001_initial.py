    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('order_status', models.CharField(choices=[('APPROVED', 'Approved'), ('PENDING', 'Pending'), ('CANCELLED', 'Cancelled')], default='PENDING', max_length=255)),
                ('approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approval_create_medication_review', to=settings.AUTH_USER_MODEL)),
                ('medicine', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.medication')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('remarks', models.TextField(blank=True, null=True)),
                ('consult', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='prescriptions', to='api.consult')),
                ('medication_review', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order', to='api.medicationreview')),
            ],
            options={
                'db_table': 'order',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offline_file', models.FileField(null=True, upload_to='offline_files/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('systolic', models.DecimalField(blank=True, decimal_places=0, max_digits=3, null=True)),
                ('diastolic', models.DecimalField(blank=True, decimal_places=0, max_digits=3, null=True)),
                ('heart_rate', models.DecimalField(blank=True, decimal_places=0, max_digits=3, null=True)),
                ('hemocue_count', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ...
                ('pubarche', models.TextField(blank=True, default="Haven't Asked / Not Applicable", null=True)),
                ('pubarche_age', models.IntegerField(blank=True, null=True)),
                ('thelarche', models.TextField(blank=True, default="Haven't Asked / Not Applicable", null=True)),
                ('thelarche_age', models.IntegerField(blank=True, null=True)),
                ('menarche', models.TextField(blank=True, default="Haven't Asked / Not Applicable", null=True)),
                ('menarche_age', models.IntegerField(blank=True, null=True)),
                ('voice_change', models.TextField(blank=True, default="Haven't Asked / Not Applicable", null=True)),
                ('voice_change_age', models.IntegerField(blank=True, null=True)),
                ('testicular_growth', models.TextField(blank=True, default="Haven't Asked / Not Applicable", null=True)),
